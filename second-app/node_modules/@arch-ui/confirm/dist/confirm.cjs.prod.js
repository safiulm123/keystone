...
const innerGutter = 15, Positioner = styled.div({
  ...
  let Tag = _ref.component, width = _ref.width, props = _objectWithoutProperties(_ref, [ "component", "width" ]);
...
class ModalConfirm extends react.PureComponent {
  ...
  render() {
    const _this$props = this.props, attachTo = _this$props.attachTo, children = _this$props.children, component = _this$props.component, width = _this$props.width, transitionState = _this$props.transitionState;
