...
import { a as walkSlateNode } from './chunk-01d864ee.esm.js';
  ...
  constructor(path, _ref2, listConfig) {
    ...
    if (!auxList) {
      auxList = listConfig.createAuxList(type, {
        ...
        access: Object.entries(listConfig.listAccess).reduce((acc, _ref5) => {
          let [schemaName, access] = _ref5;
          return _objectSpread({}, acc, {
            [schemaName]: Object.entries(access).reduce((acc, _ref6) => {
              let [op, rule] = _ref6;
              return _objectSpread({}, acc, {
                [op]: !!rule
              });
