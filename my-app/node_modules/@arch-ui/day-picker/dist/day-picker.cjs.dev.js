...
const SelectYear = React.memo((_ref2) => {
  let onChange = _ref2.onChange,
      year = _ref2.year,
      yearRangeFrom = _ref2.yearRangeFrom,
      yearRangeTo = _ref2.yearRangeTo,
      yearPickerType = _ref2.yearPickerType;
  ...
  const _useState = React.useState(year),
...
const Month = React.memo((_ref2) => {
  ...
  const _items$index = items[index],
        weeks = _items$index.weeks,
        month = _items$index.month,
        year = _items$index.year;
  return core.jsx("div", {
    ref: ref,
    "data-index": index,
...
const DayPicker = (_ref) => {
  let yearRangeFrom = _ref.yearRangeFrom,
      yearRangeTo = _ref.yearRangeTo,
      yearPickerType = _ref.yearPickerType,
      startCurrentDateAt = _ref.startCurrentDateAt,
  ...
  const _useState = React.useState(startCurrentDateAt),
        _useState2 = _slicedToArray(_useState, 2),
        date = _useState2[0],
...
const DayTimePicker = props => {
  ...
  const handleDayChange = props.handleDayChange,
        handleTimeChange = props.handleTimeChange,
        handleOffsetChange = props.handleOffsetChange,
        yearRangeFrom = props.yearRangeFrom,
        yearRangeTo = props.yearRangeTo,
        yearPickerType = props.yearPickerType;
...
let TextDayPicker = (_ref) => {
  ...
  let _useState = React.useState(formatDate(date)),
      _useState2 = _slicedToArray(_useState, 2),
      value = _useState2[0],
...
function formatDate(date) {
  return date === null ? '' : dateFns.format(date, 'Do MMMM YYYY');
}
...
function parseDate(value) {
  ...
  return dateFns.format(parsedDates[0].start.date(), 'YYYY-MM-DD');
}
...
function parseDate$1(value) {
  let _chrono$parse = chrono.parse(value),
      _chrono$parse2 = _slicedToArray(_chrono$parse, 1),
      parsedDate = _chrono$parse2[0];
