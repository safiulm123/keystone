...
const Container = styled.div((_ref) => {
  let isFullWidth = _ref.isFullWidth;
  return {
...
const FlexGroup = forwardRef((_ref2, ref) => {
  let align = _ref2.align,
      Tag = _ref2.as,
      children = _ref2.children,
      growIndexes = _ref2.growIndexes,
      isContiguous = _ref2.isContiguous,
...
const Grid = (_ref3) => {
  let alignContent = _ref3.alignContent,
      areas = _ref3.areas,
      _ref3$columns = _ref3.columns,
      columns = _ref3$columns === void 0 ? 12 : _ref3$columns,
      _ref3$flow = _ref3.flow,
      flow = _ref3$flow === void 0 ? 'row' : _ref3$flow,
      _ref3$gap = _ref3.gap,
      gap = _ref3$gap === void 0 ? 8 : _ref3$gap,
      justifyContent = _ref3.justifyContent,
      _ref3$minRowHeight = _ref3.minRowHeight,
      minRowHeight = _ref3$minRowHeight === void 0 ? 20 : _ref3$minRowHeight,
      rows = _ref3.rows,
...
export { CONTAINER_WIDTH, CONTAINER_GUTTER, Container, FlexGroup, Grid, Cell };
