...
class Pagination extends React.Component {
  ...
  renderPages() {
    let _this$props = this.props,
        ariaPageLabel = _this$props.ariaPageLabel,
  ...
  render() {
    ...
    const _this$props2 = this.props,
          ariaPageLabel = _this$props2.ariaPageLabel,
          ...
          rest = _objectWithoutProperties(_this$props2, ["ariaPageLabel", "currentPage", "isLoading", "limit", "onChange", "pageSize", "total"]);

    return (// $FlowFixMe flex group doesn't understand default props for some reason, in this instance...
      core.jsx(layout.FlexGroup, _extends({
        as: "nav",
        align: "center",
