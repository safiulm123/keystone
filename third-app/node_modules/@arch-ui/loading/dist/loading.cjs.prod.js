...
var _objectSpread = _interopDefault(require("@babel/runtime/helpers/objectSpread")), _taggedTemplateLiteral = _interopDefault(require("@babel/runtime/helpers/taggedTemplateLiteral")), React = _interopDefault(require("react")), styled = _interopDefault(require("@emotion/styled")), core = require("@emotion/core"), theme = require("@arch-ui/theme"), typography = require("@arch-ui/typography");
...
const fadeAnim = core.keyframes(_templateObject()), appearanceColor = {
  ...
  let appearance = _ref2.appearance, _ref2$delay = _ref2.delay, delay = void 0 === _ref2$delay ? 0 : _ref2$delay, isOffset = _ref2.isOffset;
  return {
  ...
  let appearance = _ref3.appearance, size = _ref3.size;
...
const spinAnim = core.keyframes(_templateObject2()), spinnerCommon = _ref4 => {
  ...
  let color = _ref6.color, size = _ref6.size;
  ...
  let color = _ref7.color, size = _ref7.size;
  return _objectSpread({}, spinnerCommon({
    size: size
  }), {
  ...
  let appearance = _ref8.appearance, size = _ref8.size;
