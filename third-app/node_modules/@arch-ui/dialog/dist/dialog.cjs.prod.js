...
class ModalDialog extends React.PureComponent {
  ...
  render() {
    const _this$props = this.props, attachTo = _this$props.attachTo, children = _this$props.children, closeOnBlanketClick = _this$props.closeOnBlanketClick, component = _this$props.component, footer = _this$props.footer, heading = _this$props.heading, initialFocus = _this$props.initialFocus, onClose = _this$props.onClose, width = _this$props.width, transitionState = _this$props.transitionState, dialogTitleId = modalUtils.generateUEID();
